...
class CheckDC:
    ...
    sql_query_full_dataset: str | None = None
    sql_query_fail_dataset: str | None = None
    ...
    def __str__(self) -> str:
        return (
            ...
            f"sql_query_pass                = {self.sql_query_full_dataset}\n"
            f"sql_query_fail                = {self.sql_query_fail_dataset}\n"
